  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-3xl bg-[#F3EEE2] text-[#1A1717]",
        "p-7 sm:p-8",
...
const ACTION_VARIANTS = {
  primary: "bg-[#1A1717] text-[#F3EEE2] hover:bg-[#333333]",
  danger: "bg-[#DC2626] text-[#F3EEE2] hover:bg-[#B91C1C]",
  warning: "bg-[#C4703D] text-[#F3EEE2] hover:bg-[#A8602F]",
  ghost: "bg-transparent text-[#1A1717] hover:bg-[#E0D5C0]",
  outline: "bg-transparent text-[#1A1717] border border-[#1A1717]/15 hover:bg-[#E0D5C0]",
}
